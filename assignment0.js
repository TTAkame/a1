...
class Triangle extends Shape
{
    ...
    constructor( gl, shader, position, color, sideLength) 
    {
        ...
        let vertices = [
            position[0], position[1] - ( sideLength / 2 ), // side 1
            position[0] - ( sideLength / 2 ) * cosangle, position[1] + ( sideLength / 2 ) * sinangle, // side 2
            position[0] + ( sideLength / 2 ) * cosangle, position[1] + ( sideLength / 2 ) * sinangle, // side 3
        ]
